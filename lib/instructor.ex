defmodule Instructor do
  ...
  Additionally, the following parameters are supported:
    ...
    * `:json_schema` - A JSON representation of the response model (optional). Defaults to a basic schema generated by `Instructor.JSONSchema.from_ecto_schema/1`, but this might not be optimal. See [this guide](https://json-schema.org/learn/getting-started-step-by-step) to learn more about JSON Schema.
  ...
  defp do_streaming_partial_chat_completion(response_model, params, config) do
    ...
    |> Stream.transform(
      ...
      # partial
      fn params, _acc ->
        # if :json_schema was not provided, the default is wrapped in a 'value' parameter.
